...
| Repeated timing distributions characterize retained-run computational cost | 100 measured repetitions after 10 warm-ups on the exact release-head runner: 12-hazard exact oracle median 34.51 ms vs critical-cut 0.170 ms; six-module history-exact median 5.16 ms, history-cut 3.65 ms, shortest 0.102 ms | SUPPORTED | runner-specific descriptive timing only; no hardware-independent runtime guarantee |
