...
| History-conditioned planning remains informative when every feasible route activates hazards | retained 24-scenario challenge artifact, 500 paired seeds/scenario: mean return-infeasibility 0.7796 state-only exact vs 0.6926 history exact; scenario-level mean difference -0.087, 95% bootstrap CI [-0.1629,-0.0247]; improved 8/24, nonworse 24/24 | SUPPORTED | structured synthetic generator; not arbitrary-map or deployment generalization |
