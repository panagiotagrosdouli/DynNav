#!/usr/bin/env python3
"""Runtime filters shared by repository documentation validators."""
...
def _safe_shlex_split(
    command: str,
    comments: bool = False,
    posix: bool = True,
) -> list[str]:
    """Return a conservative token for malformed documented commands."""

    try:
        return _ORIGINAL_SHLEX_SPLIT(
            command,
            comments=comments,
            posix=posix,
        )
