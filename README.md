...
3. Inspect the upgraded core modules from `contributions/01_learned_astar/` through `contributions/19_llm_mission_planner/`, and the safety / replanning modules.
